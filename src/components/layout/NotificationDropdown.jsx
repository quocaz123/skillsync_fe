        ...
        <div className="absolute right-0 mt-2 w-80 sm:w-96 bg-white rounded-xl shadow-xl border border-slate-200 overflow-hidden z-50 animate-in slide-in-from-top-2 duration-200">
          <div className="p-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
            <h3 className="font-bold text-slate-800 text-sm flex items-center gap-2">
              <Bell size={16} weight="duotone" className="text-violet-500" />{" "}
              Thông báo
            </h3>
            {unreadCount > 0 && (
              <button
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex gap-3">
                      <div
                        className={`w-9 h-9 rounded-full bg-${color}-100 flex items-center justify-center shrink-0`}
                      >
                        <Icon
                          size={18}
                          weight="fill"
                      ...
                      <div className="flex-1 min-w-0">
                        <p
                          className={`text-sm ${!noti.isRead ? "text-slate-900 font-bold" : "text-slate-800 font-medium"}`}
                        >
                          {noti.title}
                        </p>
