...
const EVIDENCE_DEFS = [
  {
    ...
    acceptUrl: false,
    icon: Medal,
    tips: "IELTS, TOEIC, JLPT, AWS, Google... Điểm số cụ thể = không thể giả",
  },
  {
    id: "video",
    label: "Video tự giới thiệu bằng kỹ năng đó",
    type: "mandatory",
    pts: 30,
    uploadType: "TEACHING_EVIDENCE",
    acceptUrl: true,
    icon: VideoCamera,
    tips: "2 phút nói tự nhiên — học viên nghe ngay trình độ thực sự",
  },
  {
    id: "linkedin",
    label: "LinkedIn",
    ...
    acceptUrl: true,
    icon: LinkedinLogo,
    tips: "Liên kết profile có endorsements",
  },
  {
    id: "work",
    label: "Bằng chứng làm việc/dự án",
    type: "optional",
    pts: 15,
    uploadType: "TEACHING_EVIDENCE",
    acceptUrl: true,
    icon: AirplaneTilt,
    tips: "GitHub, Portfolio, Bằng chứng sinh sống nước ngoài...",
  },
  {
    id: "teaching",
