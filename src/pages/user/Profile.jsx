    ...
    <div className="max-w-6xl mx-auto space-y-8 font-sans pb-12">
      ...
      <div className="bg-white rounded-[2rem] border border-slate-200/60 overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(90,99,246,0.1)] transition-shadow duration-300 relative group">
        ...
        <div className="h-48 w-full relative overflow-hidden bg-slate-900">
          ...
          <div className="absolute -top-24 -right-24 w-96 h-96 bg-blue-400 rounded-full mix-blend-screen filter blur-[80px] opacity-70 z-0 animate-custom-pulse-left"></div>
          <div className="absolute -bottom-24 -left-24 w-72 h-72 bg-fuchsia-400 rounded-full mix-blend-screen filter blur-[60px] opacity-60 z-0 animate-custom-pulse-right"></div>
        </div>
                  ...
                  <div className="absolute inset-0 bg-black/50 backdrop-blur-sm flex flex-col items-center justify-center text-white opacity-0 group-hover/avatar:opacity-100 transition-opacity duration-300 z-10 rounded-[1.5rem]">
                    {avatarUploading ? (
                      <CircleNotch
                        size={32}
                        weight="bold"
                        className="animate-spin mb-1 text-white/90"
                      />
                    ) : (
                      <Camera
                        size={32}
                        weight="duotone"
                        className="mb-1 text-white/90 drop-shadow-md"
                      />
                    )}
      ...
      <div className="flex justify-center">
        <div className="bg-slate-100/90 backdrop-blur-md p-1.5 rounded-2xl inline-flex shadow-inner border border-slate-200/50">
          ...
          >
            <Users
              size={20}
              weight={activeTab === "mentor" ? "duotone" : "regular"}
            />{" "}
            Giảng viên
          </button>
          <button
              ...
              {activeTab === "learner" ? (
                ...
                loadingSkills ? (
                  ...
                  <div className="w-full py-10 flex flex-col items-center justify-center bg-slate-50/50 rounded-2xl border border-dashed border-slate-200">
                    ...
                    />
                    <p className="text-slate-400 font-medium">
                      Bạn chưa thiết lập Kỹ năng giảng dạy. Thêm ngay!
                    </p>
                  </div>
                ) : (
                  teachingSkills.map((ts) => (
                    <div
                      key={ts.id}
                      className="group relative pr-10 flex items-center gap-2.5 px-5 py-3 rounded-2xl border font-bold text-sm bg-gradient-to-br from-purple-50 to-fuchsia-50/50 border-purple-200/60 shadow-sm text-purple-800 hover:shadow-purple-200 hover:-translate-y-1 transition-all"
                    >
                      <SkillDynamicIcon
                        skillName={ts.skillName}
                        defaultIcon={ts.skillIcon}
                        className="text-base"
                        size={16}
                      />
                      <span>{ts.skillName}</span>
                      <span className="text-[10px] bg-white border border-purple-100 text-purple-600 uppercase tracking-wider px-2 py-0.5 rounded-md font-black shadow-sm">
                        {ts.level}
                      </span>
                      <button
                ...
                <div className="w-full flex flex-col gap-4">
                  {loadingReviews ? (
                    ...
                    <div className="w-full py-10 flex flex-col items-center justify-center bg-slate-50/50 rounded-2xl border border-dashed border-slate-200">
                      ...
                      />
                      <p className="text-slate-400 font-medium">
                        Chưa có đánh giá nào từ học viên. Hãy hoàn thành nhiều
                        buổi học nhé!
                      </p>
                    </div>
                  ) : (
                    reviews.map((r) => (
                      <div
                        key={r.id}
                        className="bg-gradient-to-br from-amber-50 to-yellow-50/30 border border-amber-100/60 rounded-3xl p-6 shadow-sm hover:shadow-md transition-shadow"
                      >
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <div className="text-xs text-slate-500 font-medium">
                                Trải nghiệm{" "}
                                <span className="font-bold text-slate-700 bg-slate-100 px-1.5 py-0.5 rounded ml-1">
                                  {r.skillName}
                                </span>
                              </div>
                            </div>
                        ...
                        <p className="text-slate-700 text-sm italic font-medium bg-white/70 backdrop-blur-sm p-4 rounded-2xl shadow-inner border border-white">
                          "{r.comment}"
                        </p>
              ...
              <p className="text-slate-600 leading-relaxed text-sm font-medium">
                {profile?.bio || (
                  <span className="italic text-slate-400 font-normal">
                    Thông tin đang chờ được tỏa sáng. Bấm biểu tượng ✏️ để chỉnh
                    sửa.
                  </span>
                )}
              </p>
